"""
Streamlit Web Application - Air Quality Prediction
"""
...
from src.inference.predictor import predict, call_chart
...
st.sidebar.write("- Mô hình sử dụng trong dự án này là mô hình **Random Forest** với điểm mạnh là xử lý được nhiều features và cho kết quả ổn định.")
st.sidebar.write("- Bên cạnh đó có sử dụng thêm mô hình **LSTM** để thử xem với sức mạnh của mô hình học sâu thì có thể cho ra kết quả đáng chú ý hay không.")
